...
{% include image.html img="shopify-release-3.3.0-capture.png" lightbox="true" alt="Alt for image" caption="" %}
...
{% include image.html img="shopify-release-3.3.0-payment.png" lightbox="true" alt="Alt for image" caption="" %}


## Auto-Void Functionality

{% include image.html img="shopify-release-3.3.0-void.png" lightbox="true" alt="Alt for image" caption="" %}
...
{% include image.html img="shopify-release-3.3.0-applog.png" lightbox="true" alt="Alt for image" caption="" %}
